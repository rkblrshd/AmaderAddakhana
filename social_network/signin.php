...
<div class="row">
            <div class="col-sm-12">
                <div class="well">
                    <center><h1><b><i><a  style="color: white" href="main.php">আমাদের আড্ডাখানা</a></i></b></h1></center>
                </div>
            </div>
 </div>
 <div class="row">
 	<div class="col-sm-12">
 		<div class="main-content">
 			<div class="header">
 				<h4 style="text-align: center; color: #187FAB"><strong><i>Login to This website</i></strong></h4>
 			</div>
 			<div class="l-part">
 				<form action="" method="post">
 					...
 					<div class="overlap-text">
 						...
 						<a style="text-decoration: none;float: right; color: #187FAB;" data-toggle="tooltip" title="Reset Password" href="forgot_password.php"><i>Forgot Password?</i></a>
 					</div>
