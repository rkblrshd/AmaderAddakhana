...
include("includes/connection.php");
    ...
    if(isset($_POST['sign_up'])){
        ...
        values('$first_name','$last_name','$username','Hello,This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover_photo.JPG',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
