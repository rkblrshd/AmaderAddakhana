	...
	<div class="col-sm-6">
		...
		echo"
			<div id='own_posts'>
				...
				<a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a><br></a>
			</div><br><br>
		";
	}
		...
		echo"
			<div id='own_posts'>
				...
				<a href='working_on_it.php' style='float:right;'><button class='btn btn-success'>View</button></a><br>
				<a href='working_on_it.php' style='float:right;'><button class='btn btn-danger'>Delete</button></a><br></a>
			</div><br><br>
		";
	}
	}
